...
@ApiModel(description = "/RefundQueryRequest 请求参数")
public class RefundQueryRequest {
	...
	@ApiModelProperty(value = "商户订单号", example = "GYTK201805261101100000000001", notes = "", position = 9)
	private String orderNo;
	@ApiModelProperty(value = "商户退款订单号", example = "GY201805261101100000000001", notes = "商户订单号、退款订单号不能同时为空", position = 10)
